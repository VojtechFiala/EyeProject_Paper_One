...
# [1] "id_tps"   "name"     "sex"      "set"      "nat"      "age"      "stan.lab"
names(d)[c(3,2,1,14,15)] # 
...
descaleP(scale(d$SexT),"Sextypicality")==d$SexT # 

descaleP(scale(d$SexT), "Sextypicality")[1:100]
d$SexT[1:100]

cor(descaleP(scale(d$SexT), "Sextypicality")[1:943], d$SexT[1:943])
hist((descaleP(scale(d$SexT), "Sextypicality")[1:943]-d$SexT[1:943]))
