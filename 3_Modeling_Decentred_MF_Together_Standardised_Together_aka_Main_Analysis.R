...
# When standardised across cultures "Together": 
...
# We use an older version of rethinking, before cmdstanr was introded: https://github.com/rmcelreath/rethinking?tab=readme-ov-file#within-chain-multithreading
# Should work well with the new version, but mind that the model's objects are not compatible between the versions. 
