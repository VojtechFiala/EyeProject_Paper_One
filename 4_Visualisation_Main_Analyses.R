...
tiff("Posterior__ATTR_Preds_TOGETHER_STANDARDISED.tif",width=32,height=26,units="cm",res=600,compression = "lzw")
...
tiff("Posterior__SEXT_Preds_TOGETHER_STANDARDISED.tif",width=32,height=26,units="cm",res=600,compression = "lzw")
layout(matrix(1:4,byrow=T,nrow=1), widths=c(2.9,2,2,2),heights=1)
